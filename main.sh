...
TIMES="10"
CHATID="5835435616"
KEY="7492892429:AAE8088dvxkthQlTawyAoGe9D4HS_5NZOK0"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SCRIPT EASY STORE              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
# Valid Script
...
data_ip="https://raw.githubusercontent.com/easytunnel/izin/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[2;32mWhatsApp\033[0m wa.me/6285283871632"
	echo -e "      \033[2;32mTelegram\033[0m t.me/easystore"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/easytunnel/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/easytunnel/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/easytunnel/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/easytunnel/easytunnel/main/"
start=$(date +%s)
secs_to_human() {
...
echo "EASY STORE TUNNELING" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
wget ${REPO}Fls/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
echo "CAPMOPDZSTORE" > /etc/xray/username
clear
else
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/easytunnel/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/easytunnel/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/easystore"},{"text":"Contack","url":"https://wa.me/6285283871632"}]]}'
...
wget raw.githubusercontent.com/easytunnel/easytunnel/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/easytunnel/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/easytunnel/easytunnel/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/easytunnel/easytunnel/main/Cfg/m-noobz 
